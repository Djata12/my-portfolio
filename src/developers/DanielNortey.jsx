...
export default function DanielNortey() {
    return (
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-zinc-700 dark:text-zinc-400 text-xl leading-relaxed mt-10 max-w-2xl">
                            ...
                            Cloud and DevOps engineer experienced in CI/CD pipelines,
                            containerization and scalable deployment infrastructure
                            for SaaS and fintech platforms across Africa.
                        ...
                        <div className="flex flex-wrap gap-4 mt-14">
                            ...
                            <a
                                href="mailto:jamindjata@gmail.com?subject=Hiring Daniel Nortey"
                            ...
                            <a
                                href="mailto:jamindjata@gmail.com?subject=Connecting With Daniel Nortey&body=Hello Daniel Nortey, I would like to connect with you regarding a project."
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-zinc-100 dark:bg-zinc-900/80 border border-zinc-300 dark:border-zinc-800 rounded-[32px] p-10 hover:border-yellow-500/20 transition">
                            ...
                            <p className="text-zinc-700 dark:text-zinc-400 mt-8 leading-relaxed text-lg max-w-4xl">
                                ...
                                Managed deployment pipelines, Docker infrastructure
                                and cloud hosting systems for fast-growing startups
                        ...
                        <div className="bg-zinc-100 dark:bg-zinc-900/80 border border-zinc-300 dark:border-zinc-800 rounded-[32px] p-10 hover:border-yellow-500/20 transition">
                            ...
                            <p className="text-zinc-700 dark:text-zinc-400 mt-8 leading-relaxed text-lg max-w-4xl">
                                ...
                                Built scalable CI/CD pipelines, automated cloud
                                infrastructure and optimized deployment systems
                                for SaaS and fintech applications across Africa.
