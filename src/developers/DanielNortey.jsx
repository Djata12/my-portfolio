    ...
    return (
        ...
        <section className="relative px-6 py-20 border-b border-zinc-800 z-10">
            ...
            <div className="relative z-10">
                ...
                <a
                    href="mailto:jamindjata@gmail.com?subject=Daniel Nortey"
                ...
                <a
                    href="mailto:jamindjata@gmail.com?subject=Connecting With Daniel Norteyo&body=Hello Daniel Nortey, I would like to connect with you regarding a project."
        ...
        <section className="relative px-6 py-24 z-10">
            ...
            <div className="space-y-8">
                ...
                <p className="text-zinc-400 mt-8 leading-relaxed text-lg max-w-4xl">
                    ...
                    Managed deployment pipelines, Docker infrastructure and
                    cloud hosting systems for fast-growing startups and
                    digital platforms.
                </p>
